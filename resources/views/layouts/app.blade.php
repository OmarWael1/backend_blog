        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" >
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Dr Zeniab Blog') }}
                </a>
                    ...
                    {{--<ul class="navbar-nav ml-auto">--}}
                        ...
                        @else
                            <li class="nav-item active">
                                <a class="nav-link" href="{{route('users')}}">{{__('users')}} <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('articles')}}">{{__('articles')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('stories')}}">{{__('stories')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('researches')}}">{{__('researches')}}</a>
                            </li>
                            <li class="nav-item">
